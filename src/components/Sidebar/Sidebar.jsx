    ...
    <div className="sideBar">
      {!isContactsPage === true && (
        <>
          <a
            target="_blank"
            href="https://wa.me/+79673902333?text=Здравствуйте!%20Пишу%20вам%20с%20сайта%20td-horeca.ru%20%20%20%20%20%20%20%20"
          ...
          <a
            target="_blank"
            rel="nofollow noreferrer"
            href="https://telegram.me/td_horeca?text=Здравствуйте!%20Пишу%20вам%20с%20сайта%20td-horeca.ru"
            className="sideBar__nav"
          >
